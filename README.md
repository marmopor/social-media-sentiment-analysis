...
- **Predominancia por Plataforma:** El modelo LSTM predice mayoritariamente sentimiento positivo en todas las plataformas analizadas. Esto podría indicar que existe un sesgo de nuestro modelo hacia la clase positiva, lo que podría afectar la capacidad del modelo para detectar opiniones negativas y/o neutras.
